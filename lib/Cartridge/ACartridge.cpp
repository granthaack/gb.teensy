...
ACartridge::ACartridge(File romFile) {
    ...
    Serial.printf("\tValid ROM: ");
    if(checkValidRomFile(romFile)){
        Serial.printf("Yes\n");
    }
    else{
        Serial.printf("No\n");
